            ...
            <div class="row-fluid">
                <div class="span2 customfilterbox">
                    <div class="customfilterbox-inner">
                        ...
                        <select style="width: 170px" id="researcher">
                        ...
                        <p style="padding-top: 8px"align="center">
                            <button id="rebuildChart" class="btn btn-danger" onclick="getChart();">Apply</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <button id="refreshChart" class="btn btn-danger" onclick="refreshChart();">Reset</button>
                        </p>
                    </div>
                </div>
