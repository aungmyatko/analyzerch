    ...
    <div class="container-fluid" style="padding-top: 40px">
        ...
        <div class="span3 customaboutbox">
                <div class="customaboutbox1-inner">
                    ...
                    <br/>-->
                    <p style="font-size: 14px">You can view the project wiki and source folders <a href="https://wiki.smu.edu.sg/1314T1is428/Analyzerch">here</a></p>
                    <p style="font-color: #FFF; font-size: 14px; font-weight: bold">Team Analyzerch</p>
                    <p style="font-size: 14px">For more information, contact us here!<br/>Aung Myat Ko: aungmyatko.2010@sis.smu.edu.sg<br/>
