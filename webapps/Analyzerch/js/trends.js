...
var margin = {top: 20, right: 20, bottom: 150, left: 10},
width = w - margin.left - margin.right,
height = h - margin.top - margin.bottom;

var format = d3.time.format("%Y");
var start = new Date(2000,0,1);
var name = document.getElementById("headingAbout").innerHTML;
...
d3.csv("/Analyzerch/getProfessorTrend?name="+name, function(raw) {
  $("#loadingGif").hide();
  var data = [];
  ...
  svg.append("g")
    ...
    .append("text")
      ...
      .text("Number of Publications for each type by "+name);
